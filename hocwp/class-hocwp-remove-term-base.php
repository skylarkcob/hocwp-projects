...
class HOCWP_Remove_Term_Base {
	...
	public function term_link( $termlink, $term, $taxonomy ) {
		if ( $taxonomy == $this->taxonomy ) {
			...
			$termlink = apply_filters( 'hocwp_rewrite_term_link', $termlink, $term );
		}
	...
	public function init() {
		if ( ! hocwp_pretty_permalinks_enabled() ) {
			return;
		}
	...
	public function category_rewrite_rules( $rules ) {
		$rules = $this->add_rewrite_rule( 'category', $this->get_category_base(), 'category', 'category_redirect', $rules );
