...
class HOCWP_Widget_FeedBurner extends WP_Widget {
	...
	public function __construct() {
		...
		$this->admin_args = apply_filters('hocwp_widget_feedburner_admin_args', $this->admin_args);
	...
	public function widget($args, $instance) {
		...
		if(!empty($feedburner_name)) {
			...
			$widget_html = apply_filters('hocwp_widget_feedburner_html', $widget_html, $instance, $args, $this);
			echo $widget_html;
