...
class HOCWP_Widget_Tabber extends WP_Widget {
	...
	private function get_defaults() {
		$defaults = array();
		$defaults = apply_filters('hocwp_widget_tabber_defaults', $defaults);
		$args = apply_filters('hocwp_widget_tabber_args', array());
	...
	public function __construct() {
		...
		$this->admin_args = apply_filters('hocwp_widget_tabber_admin_args', $this->admin_args);
