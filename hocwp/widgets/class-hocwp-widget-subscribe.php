...
class HOCWP_Widget_Subscribe extends WP_Widget {
	...
	private function get_defaults() {
		...
		$args     = apply_filters( 'hocwp_widget_subscribe_args', array(), $this );
	...
	public function widget( $args, $instance ) {
		...
		<form class="subscribe-form hocwp-subscribe-form" method="post"
		      data-captcha="<?php echo hocwp_bool_to_int( $captcha ); ?>"
		      data-register="<?php echo hocwp_bool_to_int( $register ); ?>">
			<?php
