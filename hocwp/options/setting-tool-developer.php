...
$option->add_field(array('id' => 'compress_css', 'title' => __('Compress CSS', 'hocwp'), 'field_callback' => 'hocwp_field_input_checkbox', 'label' => __('Compress all style in current theme?', 'hocwp'), 'default' => 1));
$option->add_field(array('id' => 'compress_js', 'title' => __('Compress Javascript', 'hocwp'), 'field_callback' => 'hocwp_field_input_checkbox', 'label' => __('Compress all javascript in current theme?', 'hocwp'), 'default' => 1));
