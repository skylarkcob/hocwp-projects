...
function hocwp_register_taxonomy_administrative_boundaries($post_type = null) {
	...
	$lang = hocwp_get_language();
	$name = __('Provinces', 'hocwp');
	$singular = __('Province', 'hocwp');
	if('vi' == $lang) {
		$name = 'Tỉnh / Thành phố';
		$singular = $name;
	}
	...
	$name = __('Districts', 'hocwp');
	$singular = __('District', 'hocwp');
	if('vi' == $lang) {
		$name = 'Quận / Huyện';
		$singular = $name;
	}
	...
	if($hamlet) {
		$name = __('Hamlets', 'hocwp');
		$singular = __('Hamlet', 'hocwp');
		if('vi' == $lang) {
			$name = 'Thôn / Xóm';
			$singular = $name;
		}
	...
	$name = __('Streets', 'hocwp');
	$singular = __('Street', 'hocwp');
	if('vi' == $lang) {
		$name = 'Đường / Phố';
		$singular = $name;
	}
...
function hocwp_classifieds_post_type_and_taxonomy() {
	...
	$name = __('Prices', 'hocwp');
	$singular = __('Price', 'hocwp');
	if('vi' == $lang) {
		$name = 'Mức giá';
		$singular = $name;
	}
	...
	hocwp_register_taxonomy($args);
	$name = __('Acreages', 'hocwp');
	$singular = __('Acreage', 'hocwp');
	if('vi' == $lang) {
		$name = 'Diện tích';
		$singular = $name;
	}
	...
	if($use) {
		$name = __('Objects', 'hocwp');
		$singular = __('Object', 'hocwp');
		if('vi' == $lang) {
			$name = 'Đối tượng';
			$singular = $name;
		}
	...
	if($use) {
		$name = __('Salaries', 'hocwp');
		$singular = __('Salary', 'hocwp');
		if('vi' == $lang) {
			$name = 'Mức lương';
			$singular = $name;
		}
...
if(!is_admin()) add_action('pre_get_posts', 'hocwp_classifieds_pre_get_posts');
