...
$option = new HOCWP_Option(__('Home Settings', 'hocwp'), 'hocwp_home_setting');
$option->set_parent_slug($parent_slug);
$option->set_use_style_and_script(true);
$option->set_use_media_upload(true);

$option->add_field(array('id' => 'recent_posts', 'title' => __('Recent Posts', 'hocwp'), 'label' => __('Show recent posts on home page?', 'hocwp'), 'value' => $recent_posts, 'field_callback' => 'hocwp_field_input_checkbox'));
$option->add_field(array('id' => 'posts_per_page', 'title' => __('Posts Number', 'hocwp'), 'value' => $posts_per_page, 'field_callback' => 'hocwp_field_input_number'));
$option->add_field(array('id' => 'pagination', 'title' => __('Pagination', 'hocwp'), 'label' => __('Show pagination on home page?', 'hocwp'), 'value' => $pagination, 'field_callback' => 'hocwp_field_input_checkbox'));
