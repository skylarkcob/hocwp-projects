...
$option = new HOCWP_Option(__('SMTP Email', 'hocwp'), 'hocwp_option_smtp_email');
$option->set_parent_slug($parent_slug);
$option->add_section(array('id' => 'smtp_option', 'title' => __('SMTP Options', 'hocwp'), 'description' => __('These options only apply if you have chosen to send mail by SMTP above.', 'hocwp')));
$option->add_section(array('id' => 'testing', 'title' => __('Configuration Testing', 'hocwp'), 'description' => __('If you do not feel very confident with the above configuration, you can send a test mail to know the results.', 'hocwp')));
$option->add_field(array('id' => 'mail_from', 'title' => __('From Email', 'hocwp'), 'description' => __('You can specify the email address that emails should be sent from. If you leave this blank, the default email will be used.', 'hocwp')));
$option->add_field(array('id' => 'mail_from_name', 'title' => __('From Name', 'hocwp'), 'description' => __('You can specify the name that emails should be sent from. If you leave this blank, the emails will be sent from WordPress.', 'hocwp')));
$field_options = array(
	array(
		'id' => 'mailer_smtp',
...
$option->add_field(array('id' => 'mailer', 'title' => __('Mailer', 'hocwp'), 'field_callback' => 'hocwp_field_input_radio', 'options' => $field_options));
$field_options = array(
	array(
...
$option->add_field(array('id' => 'mail_set_return_path', 'title' => __('Return Path', 'hocwp'), 'field_callback' => 'hocwp_field_input_checkbox', 'options' => $field_options));
$option->add_field(array('id' => 'smtp_host', 'title' => __('SMTP Host', 'hocwp'), 'default' => 'localhost', 'section' => 'smtp_option'));
$option->add_field(array('id' => 'smtp_port', 'title' => __('SMTP Port', 'hocwp'), 'default' => 25, 'section' => 'smtp_option'));
$field_options = array(
	array(
		'id' => 'smtp_ssl_none',
...
$option->add_field(array('id' => 'smtp_ssl', 'title' => __('Encryption', 'hocwp'), 'field_callback' => 'hocwp_field_input_radio', 'options' => $field_options, 'section' => 'smtp_option'));
$field_options = array(
	array(
		'id' => 'smtp_auth_true',
