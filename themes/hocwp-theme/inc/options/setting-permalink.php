...
$option = new HOCWP_Option(__('Permalink', 'hocwp'), 'hocwp_permalink');
$option->set_parent_slug('hocwp_theme_option');
$option->add_field(array('id' => 'remove_taxonomy_base', 'title' => __('Remove Taxonomy Base', 'hocwp'), 'field_callback' => 'hocwp_field_sortable_taxonomy', 'connect' => true, 'description' => __('Drag and drop the taxonomy into right panel to remove it\'s base slug.', 'hocwp')));
