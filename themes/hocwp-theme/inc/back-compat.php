...
function hocwp_require_wp_version_message() {
	$message = sprintf( __( 'HocWP requires at least WordPress version %1$s. You are running version %2$s. Please upgrade and try again.', 'hocwp-theme' ), HOCWP_REQUIRE_WP_VERSION, $GLOBALS['wp_version'] );
